    ...
    override fun build2Screen(screen: DungeonScreen, subScreen: DungeonSubScreen): ScreenUI {
        return ScreenUI(screenId)
            ...
            .addComponent(TextureComp("dungeon_1", "ui/dungeon/default.png")
                ...
                .setWidth("74")
                .setHeight("102")
                .addAction(ActionType.Left_Click, "dungeon_1.texture = 'ui/dungeon/hover.png';")
                .addAction(ActionType.Left_Release, "dungeon_1.texture = 'ui/dungeon/default.png';")
                .addAction(ActionType.Left_Click, "global.dungeon_current_selected = 1;")
            ...
            .addComponent(TextureComp("dungeon_2", "ui/dungeon/default.png")
                ...
                .setWidth("74")
                .setHeight("102")
                .addAction(ActionType.Left_Click, "dungeon_2.texture = 'ui/dungeon/hover.png';")
                .addAction(ActionType.Left_Release, "dungeon_2.texture = 'ui/dungeon/default.png';")
                .addAction(ActionType.Left_Click, "global.dungeon_current_selected = 2;")
                .addAction(ActionType.Left_Click, DungeonAPI.getPluginParams())
            )
            .addComponent(TextureComp("dungeon_3", "ui/dungeon/default.png")
                ...
                .setWidth("74")
                .setHeight("102")
                .addAction(ActionType.Left_Click, "dungeon_3.texture = 'ui/dungeon/hover.png';")
                .addAction(ActionType.Left_Release, "dungeon_3.texture = 'ui/dungeon/default.png';")
                .addAction(ActionType.Left_Click, "global.dungeon_current_selected = 3;")
                .addAction(ActionType.Left_Click, DungeonAPI.getPluginParams())
            )
            .addComponent(TextureComp("dungeon_4", "ui/dungeon/default.png")
                ...
                .setWidth("74")
                .setHeight("102")
                .addAction(ActionType.Left_Click, "dungeon_4.texture = 'ui/dungeon/hover.png';")
                .addAction(ActionType.Left_Release, "dungeon_4.texture = 'ui/dungeon/default.png';")
                .addAction(ActionType.Left_Click, "global.dungeon_current_selected = 4;")
                .addAction(ActionType.Left_Click, DungeonAPI.getPluginParams())
            )
            .addComponent(TextureComp("dungeon_5", "ui/dungeon/default.png")
                ...
                .setWidth("74")
                .setHeight("102")
                .addAction(ActionType.Left_Click, "dungeon_5.texture = 'ui/dungeon/hover.png';")
                .addAction(ActionType.Left_Release, "dungeon_5.texture = 'ui/dungeon/default.png';")
                .addAction(ActionType.Left_Click, "global.dungeon_current_selected = 5;")
                .addAction(ActionType.Left_Click, DungeonAPI.getPluginParams())
            )
