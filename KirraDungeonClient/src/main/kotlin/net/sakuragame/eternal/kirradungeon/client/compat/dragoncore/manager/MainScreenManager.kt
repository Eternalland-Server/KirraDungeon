...
import net.sakuragame.eternal.kirradungeon.client.compat.dragoncore.DungeonCard
import net.sakuragame.eternal.kirradungeon.client.compat.dragoncore.DungeonRegion
...
object MainScreenManager {

    fun get(category: DungeonCategory): ScreenUI {
        return when (category) {
            DungeonCategory.NORMAL -> getNormal()
            DungeonCategory.TEAM -> getTeam()
            DungeonCategory.ACTIVITY -> getActivity()
            DungeonCategory.SPECIAL -> getSpecial()
        }
    }

    fun getNormal() = ScreenUI(Dungeon.screenId)
        .addImports(listOf(DungeonCard.screenId,
            net.sakuragame.eternal.kirradungeon.client.compat.dragoncore.DungeonCategory.screenId,
            DungeonRegion.screenId,
            DungeonRoom.screenId))
        ...
        .addComponent(LabelComp("title_text", "&f&l常规副本")
        ...
        .addComponent(TextureComp("close", "ui/dungeon/button/close.png")
            ...
            .addAction(ActionType.Left_Release, "close.texture = 'ui/dungeon/button/close_press.png';")
        )

        .addComponent(TextureComp("map_bg", "ui/dungeon/map/0.png")
        ...
        .addComponent(TextureComp("desc_img", "ui/dungeon/preview/0.png")
        ...
        .addComponent(LabelComp("desc_tip", "")
            .setXY("desc_title.x + 3", "desc_title.y + 95")
        )
    ...
    fun getTeam() = ScreenUI(Dungeon.screenId)

    fun getActivity() = ScreenUI(Dungeon.screenId)

    fun getSpecial() = ScreenUI(Dungeon.screenId)
}