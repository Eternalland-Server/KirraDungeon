...
class ExpressionDungeonIdentifier : SimpleExpression<String>() {
    ...
    override fun get(e: Event): Array<String> {
        val internalWorld = world?.getSingle(e) ?: return arrayOf("null")
        val dungeon = FunctionDungeon.getByBukkitWorldUUID(internalWorld.uid) ?: return arrayOf("null")
        return arrayOf(dungeon.dungeonWorld.worldIdentifier)
    }
}